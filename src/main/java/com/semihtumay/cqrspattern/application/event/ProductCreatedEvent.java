...
public class ProductCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4453712377630509268L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductCreatedEvent\",\"namespace\":\"com.semihtumay.cqrspattern.application.event\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"},{\"name\":\"stock\",\"type\":\"int\"}]}");
   ...
   */
  public ProductCreatedEvent(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence price, java.lang.Integer stock) {
    this.id = id;
    this.name = name;
    this.price = price;
    this.stock = stock;
   ...
   */
  public static com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder newBuilder() {
    return new com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder();
  }
   ...
   * @return A new ProductCreatedEvent RecordBuilder
   */
  public static com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder newBuilder(com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder other) {
    if (other == null) {
      return new com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder();
    } else {
      return new com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new ProductCreatedEvent RecordBuilder
   */
  public static com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder newBuilder(com.semihtumay.cqrspattern.application.event.ProductCreatedEvent other) {
    if (other == null) {
      return new com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder();
    } else {
      return new com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.semihtumay.cqrspattern.application.event.ProductCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder setPrice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder setStock(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.semihtumay.cqrspattern.application.event.ProductCreatedEvent.Builder clearStock() {
